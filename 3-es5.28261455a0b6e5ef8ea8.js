...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[3], {
  ...
  /***/
  function srcAppPagesSettingLocationSettingLocationSettingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LocationSettingPageModule", function () {
    ...
    var _app_components_components_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! @app/components/components.module */
    "./src/app/components/components.module.ts");
    /* harmony import */


    var _app_pages_setting_location_setting_location_setting_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! @app/pages/setting/location-setting/location-setting.page */
    ...
    var LocationSettingPageModule = /*@__PURE__*/function () {
      var LocationSettingPageModule = function LocationSettingPageModule() {
        _classCallCheck(this, LocationSettingPageModule);
      };

      LocationSettingPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({
        type: LocationSettingPageModule
      });
      LocationSettingPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
        factory: function LocationSettingPageModule_Factory(t) {
          return new (t || LocationSettingPageModule)();
        },
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_7__["IonicModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(routes), _app_components_components_module__WEBPACK_IMPORTED_MODULE_5__["ComponentsModule"], _agm_core__WEBPACK_IMPORTED_MODULE_0__["AgmCoreModule"]]]
      });
      return LocationSettingPageModule;
    }();

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](LocationSettingPageModule, {
        declarations: [_app_pages_setting_location_setting_location_setting_page__WEBPACK_IMPORTED_MODULE_6__["LocationSettingPage"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_7__["IonicModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"], _app_components_components_module__WEBPACK_IMPORTED_MODULE_5__["ComponentsModule"], _agm_core__WEBPACK_IMPORTED_MODULE_0__["AgmCoreModule"]]
      });
    })();
    /***/
  ...
  /***/
  function srcAppPagesSettingLocationSettingLocationSettingPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LocationSettingPage", function () {
    ...
    var _models_business_position_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! @models/business/position.model */
    "./src/app/models/business/position.model.ts");
    /* harmony import */


    var _app_pages_setting_user_location_adder_user_location_adder_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! @app/pages/setting/user-location-adder/user-location-adder.page */
    "./src/app/pages/setting/user-location-adder/user-location-adder.page.ts");
    /* harmony import */
    ...
    var _services_mobile_configuration_service_mobile_context_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var _services_background_geolocation_background_geolocation_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! @services/background-geolocation/background-geolocation.service */
    "./src/app/services/background-geolocation/background-geolocation.service.ts");
    /* harmony import */
    ...
    var _services_settings_providers_settings_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    function LocationSettingPage_ion_row_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function LocationSettingPage_ion_row_2_Template_ion_col_click_1_listener() {
          ...
          return ctx_r4.show(location_r2);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function LocationSettingPage_ion_row_2_Template_ion_button_click_4_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r5);
          ...
          return ctx_r6.removeLocation(i_r3);
        });
    ...
    var LocationSettingPage = /*@__PURE__*/function () {
      var LocationSettingPage = /*#__PURE__*/function () {
        function LocationSettingPage(mobileContextService, backgroundGeolocationService, modalCtrl, ngZone, settingsManager) {
          _classCallCheck(this, LocationSettingPage);
        ...
        _createClass(LocationSettingPage, [{
          key: "ionViewWillEnter",
          value: function ionViewWillEnter() {
            var _this = this;

            this.mobileContextService.userSettingsObservable.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.unsubscribe)).subscribe(function (userSettings) {
              if (userSettings) {
                _this.userLocations = userSettings.userLocations;
              }
            });
          }
        }, {
          ...
          value: function removeLocation(index) {
            ...
            this.ngZone.run(function () {
              _this2.userLocations.splice(index, 1);

              _this2.settingsManager.locationChanged();
            });
          }
        }, {
          key: "addLocation",
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      return this.modalCtrl.create({
                        ...
                        res.present();
                        res.onDidDismiss().then(function (data) {
                          if (data && data.data && data.data.location) {
                            _this3.userLocations.push(data.data.location);

                            _this3.settingsManager.locationChanged();
                          }
                        });
                      });
          ...
          key: "setCurrentCenter",
          value: function setCurrentCenter() {
            var position = this.backgroundGeolocationService.getLastKnownPosition();
      ...
      LocationSettingPage.ɵfac = function LocationSettingPage_Factory(t) {
        return new (t || LocationSettingPage)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_mobile_configuration_service_mobile_context_service__WEBPACK_IMPORTED_MODULE_6__["MobileContextService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_background_geolocation_background_geolocation_service__WEBPACK_IMPORTED_MODULE_7__["BackgroundGeolocationService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_8__["ModalController"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_settings_providers_settings_service__WEBPACK_IMPORTED_MODULE_9__["SettingsManager"]));
      };

      LocationSettingPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: LocationSettingPage,
        selectors: [["app-location-setting"]],
        decls: 7,
        vars: 2,
        consts: [[1, "ion-no-padding"], ["class", "ion-text-wrap", 4, "ngFor", "ngForOf"], [1, "ion-text-center", 2, "height", "340px"], ["size", "small", 3, "click"], ["translate", "location-settings.addLocation"], [4, "ngIf"], [1, "ion-text-wrap"], ["size", "10", 3, "click"], ["size", "2"], [3, "icon"], [3, "latitude", "longitude", "zoom"], [3, "latitude", "longitude", 4, "ngIf"], [3, "latitude", "longitude"]],
        template: function LocationSettingPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function LocationSettingPage_Template_ion_button_click_4_listener() {
...
//# sourceMappingURL=3-es5.28261455a0b6e5ef8ea8.js.map