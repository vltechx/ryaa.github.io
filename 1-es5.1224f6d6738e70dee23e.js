...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[1], {
  ...
  /***/
  function srcAppPagesPasswordChangeModalPasswordChangeModalPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PasswordChangeModalPage", function () {
    ...
    var _services_endpoint_endpoint_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var PasswordChangeModalPage = /*@__PURE__*/function () {
      var PasswordChangeModalPage = /*#__PURE__*/function () {
        function PasswordChangeModalPage(modalCtrl, formBuilder, endpointService, http, toastCtrl, translateService) {
          _classCallCheck(this, PasswordChangeModalPage);
        ...
        _createClass(PasswordChangeModalPage, [{
          key: "ngOnInit",
          ...
          value: function requestPasswordChange() {
          ...
          key: "togglePasswordFieldView",
          value: function togglePasswordFieldView() {
          ...
          value: function changePassword(currentPassword, newPassword) {
            ...
            var url = this.endpointService.currentEndpoint + CONFIG.PASSWORD_CHANGE_PATH;
            this.http.post(url, {
      ...
      PasswordChangeModalPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function PasswordChangeModalPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PasswordChangeModalPage_Template_ion_button_click_6_listener() {
              return ctx.dismiss();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PasswordChangeModalPage_Template_ion_button_click_14_listener() {
              return ctx.togglePasswordFieldView();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PasswordChangeModalPage_Template_ion_button_click_24_listener() {
              return ctx.requestPasswordChange();
            });
...
//# sourceMappingURL=1-es5.1224f6d6738e70dee23e.js.map