...
/* harmony import */ var _app_pages_setting_settings_tabs_router_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @app/pages/setting/settings-tabs.router.module */ "./src/app/pages/setting/settings-tabs.router.module.ts");
...
/* harmony import */ var _setting_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./setting.page */ "./src/app/pages/setting/setting.page.ts");
...
let SettingPageModule = /*@__PURE__*/ (() => {
    ...
    SettingPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({ type: SettingPageModule });
    SettingPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function SettingPageModule_Factory(t) { return new (t || SettingPageModule)(); }, imports: [[
                ...
                _app_pages_setting_settings_tabs_router_module__WEBPACK_IMPORTED_MODULE_5__["SettingsTabsRoutingModule"]
            ]] });
    return SettingPageModule;
})();
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](SettingPageModule, { declarations: [_setting_page__WEBPACK_IMPORTED_MODULE_9__["SettingPage"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
...
/* harmony import */ var _services_mobile_configuration_service_mobile_context_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @services/mobile-configuration-service/mobile-context.service */ "./src/app/services/mobile-configuration-service/mobile-context.service.ts");
...
/* harmony import */ var _services_connection_status_service_connection_status_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @services/connection-status-service/connection-status.service */ "./src/app/services/connection-status-service/connection-status.service.ts");
/* harmony import */ var _services_order_sync_order_sync_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @services/order-sync/order-sync.service */ "./src/app/services/order-sync/order-sync.service.ts");
/* harmony import */ var _services_settings_providers_settings_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @services/settings-providers/settings.service */ "./src/app/services/settings-providers/settings.service.ts");
/* harmony import */ var _services_mbls_analytics_service_MblsAnalyticsService__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @services/mbls-analytics-service/MblsAnalyticsService */ "./src/app/services/mbls-analytics-service/MblsAnalyticsService.ts");
...
/* harmony import */ var _app_components_offline_indicator_offline_indicator_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @app/components/offline-indicator/offline-indicator.component */ "./src/app/components/offline-indicator/offline-indicator.component.ts");
...
const _c0 = ["content"];
const _c1 = function () { return ["fas", "sliders-h"]; };
const _c2 = function () { return ["fas", "mobile"]; };
const _c3 = function () { return ["fas", "map-marker-edit"]; };
const CONFIG = {
    GA: {
...
let SettingPage = /*@__PURE__*/ (() => {
    class SettingPage {
        constructor(mobileContextService, log, connectionStatusService, orderSync, settingsManager, ga, platform) {
    ...
    SettingPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SettingPage, selectors: [["app-setting"]], viewQuery: function SettingPage_Query(rf, ctx) {
            if (rf & 1) {
        ...
        }, decls: 22, vars: 7, consts: [["slot", "start"], ["src", "assets/images/logo_menu.png"], ["translate", "pages.drawer-menu.settings"], [3, "content"], ["slot", "top"], ["tab", "main"], ["size", "lg", 3, "icon"], ["translate", "pages.settings.main"], ["tab", "display"], ["translate", "pages.settings.display"], ["tab", "location"], ["translate", "pages.settings.locations"]], template: function SettingPage_Template(rf, ctx) {
            if (rf & 1) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SettingsTabsRoutingModule", function() { return SettingsTabsRoutingModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _app_pages_setting_setting_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @app/pages/setting/setting.page */ "./src/app/pages/setting/setting.page.ts");
        ...
        children: [
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e(4)]).then(__webpack_require__.bind(null, /*! ./main-setting/main-setting.module */ "./src/app/pages/setting/main-setting/main-setting.module.ts")).then(m => m.MainSettingPageModule)
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => __webpack_require__.e(/*! import() */ 2).then(__webpack_require__.bind(null, /*! ./display-setting/display-setting.module */ "./src/app/pages/setting/display-setting/display-setting.module.ts")).then(m => m.DisplaySettingPageModule)
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => __webpack_require__.e(/*! import() */ 3).then(__webpack_require__.bind(null, /*! ./location-setting/location-setting.module */ "./src/app/pages/setting/location-setting/location-setting.module.ts")).then(m => m.LocationSettingPageModule)
                    }
                ]
            },
            {
...
let SettingsTabsRoutingModule = /*@__PURE__*/ (() => {
    class SettingsTabsRoutingModule {
    }
    SettingsTabsRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: SettingsTabsRoutingModule });
    SettingsTabsRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function SettingsTabsRoutingModule_Factory(t) { return new (t || SettingsTabsRoutingModule)(); }, imports: [[
                _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)
            ],
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] });
    return SettingsTabsRoutingModule;
})();
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](SettingsTabsRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] }); })();
...
//# sourceMappingURL=6-es2015.ecb85c81877e5f280da7.js.map